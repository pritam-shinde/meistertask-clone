...
const Admin = () => {
    ...
    const handleDeleteUser = async (userId) => {
        let response = await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/profile/${userId}`, {
            method: 'DELETE',
            headers: {
    ...
    const handleDeleteAdmin = async (adminId) => {
        let response = await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/admin/${adminId}`, {
            method: "DELETE",
            eaders: {
                'Content-type': 'application/json; charset=UTF-8',
            },
    ...
    const getMembers = async () => {
        let res = await fetch("https://my-json-server.typicode.com/pritam-shinde/task-api/profile", {
            method: "GET",
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
            },
    ...
    const getAdmin = async () => {
        let res = await fetch("https://my-json-server.typicode.com/pritam-shinde/task-api/admin", {
            method: "GET",
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
            },
