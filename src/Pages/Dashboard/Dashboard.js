...
const Dashboard = ({ team }) => {
    ...
    const getTask = async () => {
        await fetch("https://my-json-server.typicode.com/pritam-shinde/task-api/task").then(res => res.json()).then(data => setTaskData(data))
    }

    const getList = async () => {
        let res = await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/list/?team=${team}`).then(res => res.json()).then(data => setTaskList(data)).catch(error => console.log(error))
    }

    const addNewTask = async (task) => {
        console.log(task)
        let res = await fetch("https://my-json-server.typicode.com/pritam-shinde/task-api/task", {
            method: "POST",
    ...
    const addNewList = async (list) => {
        console.log(list)
        const res = await fetch("https://my-json-server.typicode.com/pritam-shinde/task-api/list", {
            method: "POST",
    ...
    const handleDeleteTask = async (card) => {
        let res = await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/task/${card.id}`, {
            method: "DELETE",
            headers: {
                'Content-type': 'application/json; charset=UTF-8',
            },
    ...
    const getAllTeamMember = async () => {
        await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/profile/?team=${team}`).then(res => res.json()).then(data => setAllTeamMember(data)).catch(error => console.log(error))
    }

    const showIndividual = async (user) => {
        await fetch(`https://my-json-server.typicode.com/pritam-shinde/task-api/task/?assign=${user}`).then(res => res.json()).then(data => setTaskData(data)).catch(error => console.log(error));
